...
Libraries/Infra/Ssw/TC36A/Tricore/%.src: ../Libraries/Infra/Ssw/TC36A/Tricore/%.c Libraries/Infra/Ssw/TC36A/Tricore/subdir.mk
	...
	if [ -f "$(basename $@).d" ]; then sed.exe -r  -e 's/\b(.+\.o)\b/Libraries\/Infra\/Ssw\/TC36A\/Tricore\/\1/g' -e 's/\\/\//g' -e 's/\/\//\//g' -e 's/"//g' -e 's/([a-zA-Z]:\/)/\L\1/g' -e 's/\d32:/@TARGET_DELIMITER@/g; s/\\\d32/@ESCAPED_SPACE@/g; s/\d32/\\\d32/g; s/@ESCAPED_SPACE@/\\\d32/g; s/@TARGET_DELIMITER@/\d32:/g' "$(basename $@).d" > "$(basename $@).d_sed" && cp "$(basename $@).d_sed" "$(basename $@).d" && rm -f "$(basename $@).d_sed" 2>/dev/null; else echo 'No dependency file to process';fi
...
clean: clean-Libraries-2f-Infra-2f-Ssw-2f-TC36A-2f-Tricore

clean-Libraries-2f-Infra-2f-Ssw-2f-TC36A-2f-Tricore:
	-$(RM) ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.d ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.o ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.src ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Tc0.d ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Tc0.o ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Tc0.src ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Tc1.d ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Tc1.o ./Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Tc1.src

.PHONY: clean-Libraries-2f-Infra-2f-Ssw-2f-TC36A-2f-Tricore
