...
MEMORY
{   
    dsram0_local (w!xp): org = 0xd0000000, len = 96K
    dsram0 (w!xp): org = 0x70000000, len = 96K
    psram0 (w!xp): org = 0x70100000, len = 8K
    
    psram_local (w!xp): org = 0xc0000000, len = 64K
    
    pfls0 (rx!p): org = 0x80000000, len = 1M
    pfls0_nc (rx!p): org = 0xa0000000, len = 1M
    
    dfls0 (rx!p): org = 0xaf000000, len = 96K
